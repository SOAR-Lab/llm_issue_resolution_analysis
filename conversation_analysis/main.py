import pandas as pd
from metrics import structural, linguistic, structural
from ast import literal_eval

if __name__ == '__main__':
    df = pd.read_csv('./results_gpt_issue_conversations_with_annotation.csv', converters={"prompts": literal_eval,
    ...
    for index, row in df.iterrows():
        ...
        if row['ColumnID'] == 'prompts_fulltext_clean':
            ...
            (misspelled, incomplete_count, ARI, Coleman_Liau,
    ...
    df.to_csv('./results_gpt_issue_conversations_with_annotation1.csv')
